...
import "./interfaces/ILombardMinting.sol";
import "./interfaces/IWETH9.sol";
import "./SingleAdminAccessControl.sol";

/**
 * @title Lombard Minting
 * @notice This contract mints and redeems USDe, the first staked Ethereum delta-neutral backed synthetic dollar
 */
contract LombardMinting is ILombardMinting, SingleAdminAccessControl, ReentrancyGuard {
    ...
    /// @notice EIP712 name
    bytes32 private constant EIP_712_NAME = keccak256("LombardMinting");
